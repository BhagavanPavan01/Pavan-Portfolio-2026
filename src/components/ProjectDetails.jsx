            ...
            <div className="container mx-auto px-6 md:px-12 relative" style={{ zIndex: 10 }}>
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex-1 inline-flex items-center justify-center gap-2 py-3.5 rounded-xl bg-purple-600 text-white font-bold hover:bg-purple-500 active:bg-purple-700 transition-colors duration-200"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-gray-800 text-white font-bold border border-gray-700 hover:bg-gray-700 active:bg-gray-600 transition-colors duration-200"
                            >
                            ...
                            <div className="bg-gray-900/50 backdrop-blur-md rounded-2xl p-8 border border-gray-800">
                                <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
                                    {(() => {
                                        ...
                                        return <Ic className="text-yellow-400 w-6 h-6" />;
                                    })()}
                ...
                {bottomSections.length > 0 && (
                    <motion.div
                        ...
                        className="mt-12 lg:mt-16 bg-gray-900/50 backdrop-blur-md rounded-2xl p-8 lg:p-12 border border-gray-800 max-w-7xl mx-auto"
                    >
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            {bottomSections.map((sec, idx) => {
                                ...
                                return (
                                    <div key={idx}>
                                        <h4 className="text-xl font-semibold text-purple-300 mb-6 font-mono flex items-center gap-3">
                                            <IconComp className="w-5 h-5" /> {sec.heading}
                                        </h4>
                                        <ul className="space-y-4 border-l-2 border-purple-500/30 pl-5 text-justify">
                                            {sec.items.map((item, index) => (
                                                <li key={index} className="text-gray-300 leading-relaxed flex gap-4 items-start">
                                                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 shrink-0 shadow-[0_0_10px_#c084fc]"></div>
